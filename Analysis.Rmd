...
# Discussion
The results for the dry mass (in grams) of branches and twigs fallen at the Steigerwaldt Land Service shows that the majority of litter mass fallen is typically in the winter months. From  mid-September to mid-May the dry mass is about 200 grams of fallen twigs and branches, never reaching above 200, expect for before June in which there is one outlier above 1200 grams. 

The vegetation of the Steigerwaldt Land Service consists of abundant tree species that are young, even aged stand, such as: aspen (Populus tremuloides), red maple (Acer rubrum), and balsam fir (Abies balsamea). The site is known for cold winters and even projects following ice and hail damage, windstorms, tornadoes, and spruce decline. The cold season for this site is typically from November to March with the coldest temperatures typically in January with an average of about 4 F.

Discuss the results you found. In the context of what you know about the site/sites and the predominant types of vegetation in those locations. What do the results indicate about the flow of C and N from the autotrophic biota and into the soil in comparison to what occurs at other sites and over time?
